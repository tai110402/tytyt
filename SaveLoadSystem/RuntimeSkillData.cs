...
public class RuntimeSkillData: MonoBehaviour
{
    ...
    public static void InitializeSkillDataDefaultValue()
    {
       ...
       // _skillDictionary.Add("DefaultFirstNormalAxeSkill", new Skill() { AnimationName = "DefaultFirstNormalAxeSkill", TimeCoolDown = 0f, IsUnlocked = false, IsUsing = false });
       // _skillDictionary.Add("DefaultSecondNormalAxeSkill", new Skill() { AnimationName = "DefaultSecondNormalAxeSkill", TimeCoolDown = 0f, IsUnlocked = false, IsUsing = false });
       // _skillDictionary.Add("FirstAxeSkill001", new Skill() { AnimationName = "FirstAxeSkill001", TimeCoolDown = 5f, IsUnlocked = false, IsUsing = false });
       // _skillDictionary.Add("FirstAxeSkill002", new Skill() { AnimationName = "FirstAxeSkill002", TimeCoolDown = 5f });
       // _skillDictionary.Add("FirstAxeSkill003", new Skill() { AnimationName = "FirstAxeSkill003", TimeCoolDown = 5f });
       // _skillDictionary.Add("SecondAxeSkill001", new Skill() { AnimationName = "SecondAxeSkill001", TimeCoolDown = 5f, IsUnlocked = false, IsUsing = false });
       // _skillDictionary.Add("SecondAxeSkill002", new Skill() { AnimationName = "SecondAxeSkill002", TimeCoolDown = 5f, IsUnlocked = true, IsUsing = false });
       // _skillDictionary.Add("SecondAxeSkill003", new Skill() { AnimationName = "SecondAxeSkill003", TimeCoolDown = 5f });
       // _skillDictionary.Add("ThirdAxeSkill001", new Skill() { AnimationName = "ThirdAxeSkill001", TimeCoolDown = 5f, IsUnlocked = false, IsUsing = false });
       // _skillDictionary.Add("ThirdAxeSkill002", new Skill() { AnimationName = "ThirdAxeSkill002", TimeCoolDown = 5f });
       // _skillDictionary.Add("ThirdAxeSkill003", new Skill() { AnimationName = "ThirdAxeSkill003", TimeCoolDown = 5f });
    }
